...
module.exports = {
    ...
    pow: {
        getDifficulty: (blocks, index) => {
            ...
            // INFO: The difficulty is the formula that barcoin choose to check the proof a work, this number is later converted to base 16 to represent the minimal initial hash expected value.
